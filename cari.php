...
if (isset($_GET['q'])) {
    ...
    $products = $conn->query("SELECT * FROM products WHERE nama_produk LIKE '%$search_query%' OR deskripsi LIKE '%$search_query%'");
} else {
    // Default show all or recommended
    $products = $conn->query("SELECT * FROM products LIMIT 10");
}
?>
<!DOCTYPE html>
<html lang="id">
