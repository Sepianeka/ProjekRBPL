...
if ($filter == 'kaca') {
    $products = $conn->query("SELECT * FROM products WHERE nama_produk LIKE '%kaca%'");
} elseif ($filter == 'plastik') {
    $products = $conn->query("SELECT * FROM products WHERE nama_produk LIKE '%plastik%' OR nama_produk LIKE '%cup%'");
} elseif ($filter == 'mug') {
    $products = $conn->query("SELECT * FROM products WHERE nama_produk LIKE '%mug%'");
} else {
