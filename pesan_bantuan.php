...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_keluhan']) && !$is_admin) {
    ...
    $conn->query("INSERT INTO complaints (pelanggan_id, pesanan_id, isi_keluhan) VALUES ($pelanggan_id, $pesanan_id, '$isi_keluhan')");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['tanggapi_keluhan']) && $is_admin) {
    ...
    $conn->query("UPDATE complaints SET tanggapan_admin='$tanggapan', status='Selesai' WHERE id=$keluhan_id");
